...
function FileUpload(props) {
    ...
    const firebaseConfig = {
        apiKey: 'AIzaSyBzEW2rbQMaBUXRvtQsUt2hl_PhFZVkTMs',
        authDomain: 'allanpits.web.app',
        databaseURL: 'https://isaleht-7a2e8-default-rtdb.europe-west1.firebasedatabase.app/', 
        storageBucket: 'gs://isaleht-7a2e8.appspot.com'
    };
